...
//
//    private ValidatableResponse setUpRequest(String path) {
//        RequestSpecification requestSpec = getRequestSpecBuilder()
//                .setBasePath(BASE_PATH + STORE_PATH + path)
//                .build();
//        return RestAssured
//                .given(requestSpec)
//                .when()
...
//                        .jsonPath()
//                        .getMap("");
//        MatcherAssert.assertThat(inventoryData.get("approved"),is( 50));
//        MatcherAssert.assertThat(inventoryData.get("placed"),is( 100));
//        MatcherAssert.assertThat(inventoryData.get("delivered"),is( 50));
//    }
//
//    @Test
